import pygame as pg
from data import MeetingBooBoo


class IntroNewWorld(object):

    def __init__(self):


        self.finalText = "eeerrr.... Did i black out again! My lord, what a party..."
        self.finalText2 = "                                                            Oh god whats touching me!"
        self.text = ""
        self.text2 = ""
    ...
    def change_check(self):
        if self.change == True:
            return MeetingBooBoo.openingSceneState()
